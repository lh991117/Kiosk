        ...
        switch (checkNum){
            ...
            case 2:
                if(orderNum<=drinkItemList.size() && orderNum>0){
                    System.out.println("선택한 메뉴 : "+ drinkItemList.get(checkNum-1).foodName+", "+ drinkItemList.get(checkNum-1).foodPrice+", "+ drinkItemList.get(checkNum-1).foodInfo);
                    System.out.println();
                }
            ...
            case 3:
                if(orderNum<=dessertItemList.size() && orderNum>0){
                    System.out.println("선택한 메뉴 : "+ dessertItemList.get(checkNum-1).foodName+", "+ dessertItemList.get(checkNum-1).foodPrice+", "+ dessertItemList.get(checkNum-1).foodInfo);
                    System.out.println();
                }
